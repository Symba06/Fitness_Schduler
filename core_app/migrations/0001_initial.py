    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('trainer', 'Trainer'), ('admin', 'Admin')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core_app.customuser')),
            ],
            options={
                'verbose_name': 'Тренер',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_app.trainer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_app.schedule')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_app.trainer')),
            ],
            options={
                'verbose_name': 'Запись',
